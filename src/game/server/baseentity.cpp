...
DEFINE_KEYFIELD(m_fGlowRed, FIELD_INTEGER, "glowred"),
DEFINE_KEYFIELD(m_fGlowGreen, FIELD_INTEGER, "glowgreen"),
DEFINE_KEYFIELD(m_fGlowBlue, FIELD_INTEGER, "glowblue"),
DEFINE_KEYFIELD(m_fGlowAlpha, FIELD_INTEGER, "glowalpha"),
